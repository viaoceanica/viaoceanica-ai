...
export default function Home() {
  ...
  return (
    <div className="app-shell">
      ...
      {/* Status strip hidden from UI - kept for future use
      ...
      <main className="content-grid">
        {activeTab === "upload" && (
          <>
            ...
            {/* Telemetry section hidden from UI - kept for future use
            <section className="card">
...
{/* HIDDEN: Falhas de importação and Revisão e bloqueios cards (kept for future use)
